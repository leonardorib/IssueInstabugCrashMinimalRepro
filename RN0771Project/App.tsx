      ...
      <ScrollView
        ...
        */}
        <Button
          ...
          onPress={async () => {
            ...
            console.log('Doing something async from RN 0.77.1');
            await sleep(100);
            console.log('Something went wrong from RN 0.77.1');
            throw new Error('This is an async test error from RN 0.77.1');
          }}
        />
        ...
        */}
        <Button
          ...
          onPress={() => {
            throw new Error('This is a sync test error from RN 0.77.1');
          }}
        />
      </ScrollView>
    </SafeAreaView>
